 ...
 * 你不必从头学起就能开始编写程序
    ...
    在纯函数式编程语言中，你必须使用 monad 才能打印变量或者读取 DOM 节点。而 JavaScript 做起这些来非常容易，所以我们就可以在这上面耍点小聪明，毕竟我们要学习的是如何编写纯函数式的代码。JavaScript 也更容易入门，因为它是一门混合范式的语言，你随时可以在感觉吃力的时候退回到原有的编程习惯上去。
