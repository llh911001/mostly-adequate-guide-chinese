...
在本章，我们将通过 [*semigroup*][wiki-semigroup] 介绍 [*monoids*][wiki-monoid]。 如果把数学的抽象比作头发，那么 *Monoids* 就是头发上的泡泡糖，它们捉取各种概念，这些概念横跨多种法则，真正地、象征地将它们集合到一起。它们是联系这些计算的神秘之力，是我们代码库的氧气，是代码运作的根基，量子纠缠的编码。
